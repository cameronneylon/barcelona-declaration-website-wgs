...
Open funding metadata is essential for building a more trustworthy, equitable and efficient research ecosystem. When provided in structured, machine-readable formats and accompanied by persistent identifiers, it unambiguously links funding to the correct researchers, organizations, projects and outputs. This connection enables these resources to be discovered, evaluated and reused at scale. Furthermore, making this information openly available reduces administrative burden and reporting errors  and improves interoperability (e.g. across repositories, CRIS and funder systems).
...
<ul>
  <li><b>Transparency</b> – clear view of how funding is used</li>
  <li><b>Attribution</b> – proper recognition in research outputs</li>
  <li><b>Impact Tracking</b> – easier monitoring of funded outcomes</li>
  <li><b>Collaboration</b> – enables partnerships and reduces duplication</li>
...
{{< /rawhtml >}}
- **Austrian Science Fund (FWF)**: https://www.fwf.ac.at/en/discover/research-radar ; https://www.fwf.ac.at/en/news/detail/neue-identifikations-nummer-fuer-fwf-projekte 
- **Dutch Research Council (NWO)**: https://www.nwo.nl/en/news/nwo-funded-research-projects-get-unique-identifier-with-grant-id  	
- **Fonds du Recherche du Québec**: https://frq.gouv.qc.ca/en/persistent-unique-identifiers-doi/
